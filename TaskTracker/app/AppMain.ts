...
import { FilterController } from "./classes/FilterController"
...
export class AppMain {
    public run() {
        ...
        let vcTodos = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        ...
        let vcProjects = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        ...
        let vcProjectBugs = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        ...
        let vcBugNotes = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        vcBugNotes.CreateView("Notes", persistence, "#bugNoteTemplateContainer", noteTemplate, "#createBugNote", false, vcProjectBugs);

        let vcProjectTasks = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        ...
        let vcSubtasks = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        vcSubtasks.CreateView("Tasks", persistence, "#taskTaskTemplateContainer", taskTemplate, "#createSubtask", false, vcProjectTasks);

        let vcProjectContacts = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        ...
        let vcProjectLinks = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        vcProjectLinks.CreateView("Links", persistence, "#projectLinkTemplateContainer", linkTemplate, "#createProjectLink", false, vcProjects);

        let vcProjectTaskLinks = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        ...
        let vcProjectNotes = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
        vcProjectNotes.CreateView("Notes", persistence, "#projectNoteTemplateContainer", noteTemplate, "#createProjectNote", false, vcProjects);

        let vcProjectTaskNotes = new EntityViewController(filterables, storeManager, parentChildRelationshipStore, eventRouter, auditLogStore, relationships);
